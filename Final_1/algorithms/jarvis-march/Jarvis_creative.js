...
class Point {
  ...
  function setup() 
  {
    ...
    startButton.addEventListener('click', async () => {
        if (points.length > 1) {
            hullPoints = await ConvexHull1(points); // Calculate the convex hull
  ...
  {
    //console.log("hey");
    stroke(128, 0, 128); // Set line color to black
    strokeWeight(2);
  ...
  async function ConvexHull1(points) 
  {
